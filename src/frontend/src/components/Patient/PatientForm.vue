        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-material form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-md-12" for="example-email"> NRC No:
                        </label>
                        <div class="col-md-12">
                            <input type="text"  :class="{'is-invalid':  errors.nrc ? true : false}" v-model="patient.nrc" class="form-control" placeholder="Enter Patient NRC No:">
                             <div class="invalid-feedback">
                   ...
                   <div class="form-group">
                        <label class="col-md-12" for="example-email"> Phone No:
                        </label>
                        <div class="col-md-12">
                     ...
                     <div class="form-group col-md-12">
                        ...
                        <select v-model="patient.type" class="form-control">
                            <option  value="1">consultation</option>
                            <option value="2">in hospital</option>
                        </select>
                        </div>
                    <div class="form-group">
                        <label class="col-md-12" for="example-email"> City
                        </label>
                        <div class="col-md-12">
                     ...
                     <div class="form-group">
                        <label class="col-md-12" for="example-email"> Address
                        </label>
                        <div class="col-md-12">
                    ...
                    <div class="col-12  text-center">       
                       <button @click.prevent="formsubmit()" type="submit" :disabled="$store.state.loading" class="btn  btn-info waves-effect waves-light m-r-10">
